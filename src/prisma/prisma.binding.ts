...
export interface Query {
  ...
  movieRelations: <T = MovieRelation[]>(
    args: {
  ...
  movie: <T = Movie | null>(
    args: { where: MovieWhereUniqueInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  roomsConnection: <T = RoomConnection>(
    args: {
      where?: RoomWhereInput;
      orderBy?: RoomOrderByInput;
      skip?: Int;
  ...
  movieRelationsConnection: <T = MovieRelationConnection>(
    args: {
      where?: MovieRelationWhereInput;
      orderBy?: MovieRelationOrderByInput;
      skip?: Int;
  ...
  moviesConnection: <T = MovieConnection>(
    args: {
      where?: MovieWhereInput;
      orderBy?: MovieOrderByInput;
      skip?: Int;
...
export interface Mutation {
  ...
  createMovieRelation: <T = MovieRelation>(
    args: { data: MovieRelationCreateInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  createUser: <T = User>(
  ...
  createMovie: <T = Movie>(
    args: { data: MovieCreateInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  updateRoom: <T = Room | null>(
  ...
  updateManyRooms: <T = BatchPayload>(
    args: { data: RoomUpdateInput; where?: RoomWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  updateManyMovieRelations: <T = BatchPayload>(
  ...
  updateManyMovies: <T = BatchPayload>(
    args: { data: MovieUpdateInput; where?: MovieWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  deleteManyRooms: <T = BatchPayload>(
    args: { where?: RoomWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  deleteManyMovieRelations: <T = BatchPayload>(
    args: { where?: MovieRelationWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
  ...
  deleteManyMovies: <T = BatchPayload>(
    args: { where?: MovieWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<T>;
}
...
export interface Subscription {
  room: <T = RoomSubscriptionPayload | null>(
    args: { where?: RoomSubscriptionWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<AsyncIterator<T>>;
  movieRelation: <T = MovieRelationSubscriptionPayload | null>(
    args: { where?: MovieRelationSubscriptionWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<AsyncIterator<T>>;
  ...
  movie: <T = MovieSubscriptionPayload | null>(
    args: { where?: MovieSubscriptionWhereInput },
    info?: GraphQLResolveInfo | string,
    options?: Options,
  ) => Promise<AsyncIterator<T>>;
}
